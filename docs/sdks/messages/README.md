...
async function run() {
  const result = await auroraChatbotSDK.messages.save("system", "<value>", 1719363309, 25408);
...
| `timestamp`                                                                                                                                                                    | *number*                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                             | N/A                                                                                                                                                                            | [object Object]                                                                                                                                                                |
...
async function run() {
  const result = await auroraChatbotSDK.messages.history(8);
