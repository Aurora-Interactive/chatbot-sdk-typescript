 ...
 */
export async function charactersCreate(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CharactersCreateRequestBody$outboundSchema.optional().parse(value$),
    ...
    const context = { operationID: "characters.create", oAuth2Scopes: [], securitySource: null };
