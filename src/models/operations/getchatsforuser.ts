...
/** @internal */
export const GetChatsForUserResponse$inboundSchema: z.ZodType<
    GetChatsForUserResponse,
    z.ZodTypeDef,
    unknown
> = z.union([
    z.lazy(() => GetChatsForUserSuccessfulRequest$inboundSchema),
    components.BadRequestError$inboundSchema,
    components.AuthenticationFailedError$inboundSchema,
]);

/** @internal */
export type GetChatsForUserResponse$Outbound =
    | GetChatsForUserSuccessfulRequest$Outbound
    | components.BadRequestError$Outbound
    | components.AuthenticationFailedError$Outbound;

/** @internal */
export const GetChatsForUserResponse$outboundSchema: z.ZodType<
    GetChatsForUserResponse$Outbound,
    z.ZodTypeDef,
    GetChatsForUserResponse
> = z.union([
    z.lazy(() => GetChatsForUserSuccessfulRequest$outboundSchema),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GetChatsForUserResponse$ {
    /** @deprecated use `GetChatsForUserResponse$inboundSchema` instead. */
    export const inboundSchema = GetChatsForUserResponse$inboundSchema;
    /** @deprecated use `GetChatsForUserResponse$outboundSchema` instead. */
    export const outboundSchema = GetChatsForUserResponse$outboundSchema;
    /** @deprecated use `GetChatsForUserResponse$Outbound` instead. */
    export type Outbound = GetChatsForUserResponse$Outbound;
}
